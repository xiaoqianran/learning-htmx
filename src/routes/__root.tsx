...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        title: "HTMX 实战学习 · 系统路径",
      },
      {
        name: "description",
        content:
          "HTMX 中文交互教程：属性驱动 AJAX、真 Demo、文档地图、速查表、全栈工坊与结业证明。",
      },
    ],
    links: [
